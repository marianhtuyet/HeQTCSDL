...
//            dpNgaySinh.setValue(LocalDate.parse(hocsinh.getNgaySinh().toString()));
    ...
    public void ShowChiTietChuyenDi(String MaChuyenDi) {
     ...
     public void ShowThamGiaChuyenDi(String MaChuyenDi) {
        AnchorPane paneChiTietChuyenDi = new AnchorPane();
        FXMLLoader fXMLLoader = MainController.getMainController().createPage(paneChiTietChuyenDi, "/quanlychuyendichoi/ThamGia.fxml");
